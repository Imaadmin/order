    ...
    var mcfish = {
        ...
        Tools: {
            ...
            errorAction: function (XMLHttpRequest) {
                ...
                } else if (XMLHttpRequest.status == 209) {
                    mizhu.toast("暂无权限", 1000);
            ...
            setImage: function (obj, url) {
                var df = "http://wx.qlogo.cn/mmopen/vi_32/nrZwlTIgnN95WrbOdcJHYfGR6PqAd3NEVNevWIlADOibM8ojK51moJcgUyia8lcUmOVk8PkliaA3V9jBfemicdJQOA/0";
